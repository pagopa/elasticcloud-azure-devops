locals {
  ...
  base_iac_variables = {
    ...
    #    TF_POOL_NAME_DEV  = "${local.prefix}-dev-linux-infra",
    #    TF_POOL_NAME_UAT  = "${local.prefix}-uat-linux-infra",
    #    TF_POOL_NAME_PROD = "${local.prefix}-prod-linux-infra",
    #PLAN
...
module "iac_code_review" {
  ...
  variables = merge(
    ...
    contains(each.value.envs, "d") && try(each.value.kv_name, "") != "" ? {
      tf_dev_aks_apiserver_url         = module.dev_secrets[each.value.name].values["${each.value.target}-d-itn-dev-aks-apiserver-url"].value,
      tf_dev_aks_azure_devops_sa_cacrt = module.dev_secrets[each.value.name].values["${each.value.target}-d-itn-dev-aks-azure-devops-sa-cacrt"].value,
      tf_dev_aks_azure_devops_sa_token = base64decode(module.dev_secrets[each.value.name].values["${each.value.target}-d-itn-dev-aks-azure-devops-sa-token"].value),
      second_tf_dev_aks_apiserver_url  = module.dev_secrets[each.value.name].values["${each.value.target}-d-itn-dev-aks-apiserver-url"].value,
      tf_dev_aks_azure_devops_sa_cacrt = module.dev_secrets[each.value.name].values["${each.value.target}-d-itn-dev-aks-azure-devops-sa-cacrt"].value,
      tf_dev_aks_azure_devops_sa_token = base64decode(module.dev_secrets[each.value.name].values["${each.value.target}-d-itn-dev-aks-azure-devops-sa-token"].value),
    } : {},
    #    contains(each.value.envs, "u") && try(each.value.kv_name, "") != "" ? {
    #      tf_uat_aks_apiserver_url         = module.uat_secrets[each.value.name].values["p4pa-u-itn-uat-aks-apiserver-url"].value,
    #      tf_uat_aks_azure_devops_sa_cacrt = module.uat_secrets[each.value.name].values["p4pa-u-itn-uat-aks-azure-devops-sa-cacrt"].value,
    #      tf_uat_aks_azure_devops_sa_token = base64decode(module.uat_secrets[each.value.name].values["p4pa-u-itn-uat-aks-azure-devops-sa-token"].value),
    #    } : {},
    #    contains(each.value.envs, "p") && try(each.value.kv_name, "") != "" ? {
    #      tf_prod_aks_apiserver_url         = module.prod_secrets[each.value.name].values["p4pa-p-itn-prod-aks-apiserver-url"].value,
    #      tf_prod_aks_azure_devops_sa_cacrt = module.prod_secrets[each.value.name].values["p4pa-p-itn-prod-aks-azure-devops-sa-cacrt"].value,
    #      tf_prod_aks_azure_devops_sa_token = base64decode(module.prod_secrets[each.value.name].values["p4pa-p-itn-prod-aks-azure-devops-sa-token"].value),
    #    } : {},
...
##    local.base_iac_variables,
##    contains(each.value.envs, "d") && try(each.value.kv_name, "") != "" ? {
##      tf_dev_aks_apiserver_url         = module.dev_secrets[each.value.name].values["p4pa-d-itn-dev-aks-apiserver-url"].value,
##      tf_dev_aks_azure_devops_sa_cacrt = module.dev_secrets[each.value.name].values["p4pa-d-itn-dev-aks-azure-devops-sa-cacrt"].value,
##      tf_dev_aks_azure_devops_sa_token = base64decode(module.dev_secrets[each.value.name].values["p4pa-d-itn-dev-aks-azure-devops-sa-token"].value),
##    } : {},
##    contains(each.value.envs, "u") && try(each.value.kv_name, "") != "" ? {
##      tf_uat_aks_apiserver_url         = module.uat_secrets[each.value.name].values["p4pa-u-itn-uat-aks-apiserver-url"].value,
##      tf_uat_aks_azure_devops_sa_cacrt = module.uat_secrets[each.value.name].values["p4pa-u-itn-uat-aks-azure-devops-sa-cacrt"].value,
